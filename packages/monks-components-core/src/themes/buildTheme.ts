...
export default function buildTheme(
  ...
  const ui = {
    ...
    borderWidth,
    borderWidthThick,
    boxShadow: `0 ${boxShadow[0] * 2}px ${boxShadow[1] * 4}px ${toRGBA(
      boxShadowColor,
      12,
    )}`,
    boxShadowMedium: `0 ${boxShadow[0] * 3}px ${boxShadow[1] * 5}px ${toRGBA(
      boxShadowColor,
      20,
    )}`,
    boxShadowLarge: `0 ${boxShadow[0] * 4}px ${boxShadow[1] * 7}px ${toRGBA(
      boxShadowColor,
      28,
    )}`,
    disabledOpacity,
  ...
  return {
    ...
    pattern: {
      ...
      themedFocus: {
        outline: 'none',
        boxShadow: `${accent.bg} 0px 0px 0px 2px, ${
          accent.outline
        } 0px 0px 0px 3px, ${toRGBA(accent.bg, 50)} 0px 0px 0px 4px`,
      },
      ...
      smallButton: {
        ...font.textSmall,
        padding: `${unit - borderWidthThick}px ${
          unit * 1.5 - borderWidthThick
        }px`,
      },

      regularButton: {
        ...font.textRegular,
        padding: `${unit * 1.25 - borderWidthThick}px ${
          unit * 1.5 - borderWidthThick
        }px`,
      },
      ...
      largeButton: {
        ...font.textLarge,
        padding: `${unit * 1.5 - borderWidthThick}px ${
          unit * 2 - borderWidthThick
        }px`,
      },
    },
    breakpoints,
